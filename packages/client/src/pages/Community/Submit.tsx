...
import { SelectFlair } from "@/components/Community/Common/Member/SelectFlair";
...
export default function Submit() {
    ...
    return (
        <Layout>
            <div className="flex-col grid grid-cols-3 gap-12">
                ...
                <div className="flex flex-col grid-cols-1">
                    {communities.data?.find(x => x.id == community.data.id) && (
                        <div className="px-8">
