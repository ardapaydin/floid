...
import { Ban, List, Settings, Shield, ShieldHalf, Tag } from "lucide-react";
    ...
    return (
        <div className="bg-[#222] max-w-1/4 p-4 flex-1 h-full rounded-lg">
            <div className="flex flex-col my-4 gap-4">
                ...
                <div onClick={() => setPage("bans")}
                    className={cn("hover:bg-[#333]/20 transition cursor-pointer w-full flex py-3 xl:px-4 rounded-lg gap-2 text-sm items-center", isOpen("bans"))}>
                    <Ban />
                    Bans
                </div>

                <div onClick={() => setPage("flairs")}
                    className={cn("hover:bg-[#333]/20 transition cursor-pointer w-full flex py-3 xl:px-4 rounded-lg gap-2 text-sm items-center", isOpen("flairs"))}>
                    <Tag />
                    Flairs
                </div>
